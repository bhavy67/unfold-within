      ...
      <div className="w-full">
        ...
        <div className="relative">
          <input
            ...
            } bg-white text-brand-900 placeholder:text-brand-400 focus:outline-none focus:ring-2 focus:ring-brand-500 focus:border-transparent transition-all duration-200 pr-12 ${className}`}
            {...props}
          />
          <button
            type="button"
